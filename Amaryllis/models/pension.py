...
def life_annuity(i=I, population=POPULATION, x=X, n=N, due=True, f=F, lifespan=LIFESPAN):
    ...
    if due:  
        ...
        Nx = Nc(i, population[x + f :], x + f, lifespan)
        Nx_n = Nc(i, population[x + n + f :], x + n + f, lifespan)
        a = (Nx - Nx_n) / Dx
        ...
        Nx_1 = Nc(i, population[x + f + 1 :], x + f + 1, lifespan)
        Nx_n1 = Nc(i, population[x + n + f + 1 :], x + n + f + 1, lifespan)
        a = (Nx_1 - Nx_n1) / Dx
...
def increasing_life_annuity(i=I, population=POPULATION, x=X, n=N, due=True, f=F, lifespan=LIFESPAN):
    ...
    if due:
        ...
        Nx_n = Nc(i, population[x + f + n :], x + f + n, lifespan)
        ...
        Nx_n1 = Nc(i, population[x + f + n + 1 :], x + f + n + 1, lifespan)
